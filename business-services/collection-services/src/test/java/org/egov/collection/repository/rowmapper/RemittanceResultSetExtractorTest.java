...
class RemittanceResultSetExtractorTest {
    ...
    void testExtractData() throws SQLException, DataAccessException {
        ...
        assertEquals(1, remittanceResultSetExtractor.extractData(resultSet).size());
    ...
    void testExtractData2() throws SQLException, DataAccessException {
        ...
        when(resultSet.next()).thenReturn(true).thenReturn(true).thenReturn(false);
        assertThrows(EmptyResultDataAccessException.class, () -> remittanceResultSetExtractor.extractData(resultSet));
