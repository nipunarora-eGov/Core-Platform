...
class PaymentWorkflowValidatorTest {
    ...
    void testValidateForRemit() {
        ...
        assertTrue(paymentWorkflowValidator.validateForRemit(paymentWorkflows, new ArrayList<>()).isEmpty());
    }
    ...
    void testValidateForRemit2() {
        ...
        assertThrows(CustomException.class,
                () -> paymentWorkflowValidator.validateForRemit(paymentWorkflowList, new ArrayList<>()));
    }
    ...
    void testValidateForRemit3() {
        ...
        assertTrue(paymentWorkflowValidator.validateForRemit(paymentWorkflows, paymentList).isEmpty());
    }
    ...
    void testValidateForRemit4() {
        ...
        doNothing().when(paymentWorkflow).setAdditionalDetails((JsonNode) any());
        ...
        verify(paymentWorkflow).setAdditionalDetails((JsonNode) any());
    ...
    void testValidateForCancel() {
        ArrayList<PaymentWorkflow> paymentWorkflows = new ArrayList<>();
        ArrayList<Payment> paymentList = new ArrayList<>();
        assertTrue(paymentWorkflowValidator.validateForCancel(paymentWorkflows, paymentList).isEmpty());
    ...
    void testValidateForCancel2() {
        ...
        paymentWorkflowList.add(paymentWorkflow);
        assertThrows(CustomException.class,
                () -> paymentWorkflowValidator.validateForCancel(paymentWorkflowList, new ArrayList<>()));
    }
