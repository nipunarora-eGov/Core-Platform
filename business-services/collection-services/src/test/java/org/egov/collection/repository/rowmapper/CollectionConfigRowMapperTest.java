...
class CollectionConfigRowMapperTest {
    ...
    void testExtractData() throws SQLException, DataAccessException {
        ...
        Map<String, List<String>> actualExtractDataResult = collectionConfigRowMapper.extractData(resultSet);
    ...
    void testExtractData2() throws SQLException, DataAccessException {
        ...
        when(resultSet.next()).thenReturn(true).thenReturn(true).thenReturn(false);
        assertThrows(SQLException.class, () -> collectionConfigRowMapper.extractData(resultSet));
