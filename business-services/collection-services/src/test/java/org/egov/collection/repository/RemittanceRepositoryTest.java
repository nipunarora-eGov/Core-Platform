...
@ContextConfiguration(classes = {RemittanceRepository.class, MultiStateInstanceUtil.class})
...
class RemittanceRepositoryTest {
    ...
    void testSaveRemittance() {
        assertThrows(CustomException.class, () -> remittanceRepository.saveRemittance(new Remittance()));
        assertThrows(CustomException.class, () -> remittanceRepository.saveRemittance(null));
    }
    ...
    void testSaveRemittance2() {
        ...
        assertThrows(CustomException.class, () -> remittanceRepository.saveRemittance(remittance));
    }
    ...
    void testFetchRemittances() throws DataAccessException {
        ...
        List<Remittance> actualFetchRemittancesResult = remittanceRepository.fetchRemittances(remittanceSearchRequest);
