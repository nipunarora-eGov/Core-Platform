...
class ReceiptValidator_v1Test {
    ...
    void testValidateUserInfo() {
        ...
        receiptValidator_v1.validateUserInfo(receiptReq, stringStringMap);
    ...
    void testValidateUserInfo4() {
        ...
        HashMap<String, String> stringStringMap = new HashMap<>();
        receiptValidator_v1.validateUserInfo(receiptRequest_v1, stringStringMap);
    ...
    void testValidateUserInfo5() {
        ...
        when(receiptRequest_v1.getRequestInfo())
                .thenReturn(new RequestInfo("42", "INVALID_USER_INFO", 1L, "INVALID_USER_INFO", "INVALID_USER_INFO",
    ...
    void testValidateUserInfo6() {
        ReceiptRequest_v1 receiptRequest_v1 = mock(ReceiptRequest_v1.class);
        PlainAccessRequest plainAccessRequest = new PlainAccessRequest();
        when(receiptRequest_v1.getRequestInfo()).thenReturn(
                new RequestInfo("42", "INVALID_USER_INFO", 1L, "INVALID_USER_INFO", "INVALID_USER_INFO", "INVALID_USER_INFO",
                        "42", "ABC123", "42", plainAccessRequest, new User(123L, "janedoe", "INVALID_USER_ID", "INVALID_USER_ID",
                        "42", "42", new ArrayList<>(), "42", "01234567-89AB-CDEF-FEDC-BA9876543210")));
        receiptValidator_v1.validateUserInfo(receiptRequest_v1, new HashMap<>());
        verify(receiptRequest_v1, atLeast(1)).getRequestInfo();
    }
    ...
    void testValidateUserInfo7() {
        ReceiptRequest_v1 receiptRequest_v1 = mock(ReceiptRequest_v1.class);
        PlainAccessRequest plainAccessRequest = new PlainAccessRequest();
        when(receiptRequest_v1.getRequestInfo()).thenReturn(new RequestInfo("42", "INVALID_USER_INFO", 1L,
                "INVALID_USER_INFO", "INVALID_USER_INFO", "INVALID_USER_INFO", "42", "ABC123", "42", plainAccessRequest,
