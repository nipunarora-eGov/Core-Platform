...
CREATE INDEX IF NOT EXISTS  idx_egbs_bill_v1_status ON public.egbs_bill_v1 USING btree (status);
CREATE UNIQUE INDEX IF NOT EXISTS  pk_egbs_bill_v1 ON public.egbs_bill_v1 USING btree (id, tenantid,status);
...
CREATE UNIQUE INDEX IF NOT EXISTS  pk_egbs_billdetail_v1 ON public.egbs_billdetail_v1 USING btree (id, tenantid,businessservice);
